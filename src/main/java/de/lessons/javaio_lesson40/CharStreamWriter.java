...
public class CharStreamWriter {
    public static void main(String[] args) {
        ...
        try {
            FileWriter writer = new FileWriter("src/main/java/de/lessons/javaio_lesson40/output.txt"); // Создаем FileWriter для записи в файл / Create FileWriter to write to the file
